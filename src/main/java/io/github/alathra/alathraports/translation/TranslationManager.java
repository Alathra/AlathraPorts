package io.github.alathra.alathraports.translation;
...
import io.github.alathra.alathraports.utility.FileUtils;
...
public class TranslationManager implements Reloadable {
     ...
     */
    public TranslationManager(AlathraPorts plugin) {
        this.plugin = plugin;
    }
