package io.github.alathra.alathraports.updatechecker;
...
public class UpdateChecker implements Reloadable {
    ...
    public void onEnable() {
        setPluginName(AlathraPorts.getInstance().getPluginMeta().getName());
        setCurrentVersion(SemanticVersion.of(AlathraPorts.getInstance().getPluginMeta().getVersion()));
        performUpdateCheck();
    }
